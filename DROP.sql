...
DROP TRIGGER BI_ACADEMIC_HISTORY;
DROP TRIGGER BI_CLINICAL_ANAMNESIS;
DROP TRIGGER BI_EMOTIONAL_ASPECT;
DROP TRIGGER BI_FAMILY_HISTORY;
DROP TRIGGER BI_HEALTH_HISTORY;
DROP TRIGGER BI_MAIN_COMPLAINT;
DROP TRIGGER BI_PROFESSIONAL_HISTORY;
DROP TRIGGER BI_PATIENT_IDENTIFICATION;
DROP TRIGGER BI_ROUTINE_HABIT;
DROP TRIGGER BI_SOCIAL_HISTORY;
DROP TRIGGER BI_THERAPY_EXPECTATION;
COMMIT WORK;
...
DROP GENERATOR SQ_ACADEMIC_HISTORY;
DROP GENERATOR SQ_CLINICAL_ANAMNESIS;
DROP GENERATOR SQ_EMOTIONAL_ASPECT;
DROP GENERATOR SQ_FAMILY_HISTORY;
DROP GENERATOR SQ_HEALTH_HISTORY;
DROP GENERATOR SQ_MAIN_COMPLAINT;
DROP GENERATOR SQ_PROFESSIONAL_HISTORY;
DROP GENERATOR SQ_PATIENT_IDENTIFICATION;
DROP GENERATOR SQ_ROUTINE_HABIT;
DROP GENERATOR SQ_SOCIAL_HISTORY;
DROP GENERATOR SQ_THERAPY_EXPECTATION;
COMMIT WORK;
