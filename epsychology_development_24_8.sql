...
COMMENT ON TABLE TBCUSTOMER IS '';
COMMENT ON COLUMN TBCUSTOMER.ID_ IS '';
COMMENT ON COLUMN TBCUSTOMER.NAMEBIOLOGICAL IS '';
COMMENT ON COLUMN TBCUSTOMER.NAMESOCIAL IS '';
COMMENT ON COLUMN TBCUSTOMER.BIRTHDATE IS '';
COMMENT ON COLUMN TBCUSTOMER.DOCCPF IS '';
COMMENT ON COLUMN TBCUSTOMER.DOCRG IS '';
COMMENT ON COLUMN TBCUSTOMER.IDBIOLOGICALSEX_ IS '';
COMMENT ON COLUMN TBCUSTOMER.IDSEXUALORIENTATION_ IS '';
COMMENT ON COLUMN TBCUSTOMER.IDGENDEREXPRESSION_ IS '';
COMMENT ON COLUMN TBCUSTOMER.IDGENDERIDENTITY_ IS '';
COMMENT ON COLUMN TBCUSTOMER.IDMARITAL_ IS '';
COMMENT ON COLUMN TBCUSTOMER.IDRELIGION_ IS '';
COMMENT ON COLUMN TBCUSTOMER.IDBLOOD_ IS '';
COMMENT ON COLUMN TBCUSTOMER.IDZOODIAC_ IS '';
COMMENT ON COLUMN TBCUSTOMER.IDETHNICITY_ IS '';
COMMENT ON COLUMN TBCUSTOMER.IDOCCUPATION_ IS '';
...
COMMENT ON TABLE TBFAMILY IS '';
COMMENT ON COLUMN TBFAMILY.IDCUSTOMER_ IS '';

COMMENT ON COLUMN TBFAMILY.NAMEFATHER IS '';
COMMENT ON COLUMN TBFAMILY.IDOCCUPATIONFATHER_ IS '';
COMMENT ON COLUMN TBFAMILY.DDDFATHER IS '';
COMMENT ON COLUMN TBFAMILY.FONEFATHER IS '';

COMMENT ON COLUMN TBFAMILY.NAMEMOTHER IS '';
COMMENT ON COLUMN TBFAMILY.IDOCCUPATIONMOTHER_ IS '';
COMMENT ON COLUMN TBFAMILY.DDDMOTHER IS '';
COMMENT ON COLUMN TBFAMILY.FONEMOTHER IS '';

COMMENT ON COLUMN TBFAMILY.NAMEPARTNER IS '';
COMMENT ON COLUMN TBFAMILY.IDOCCUPATIONPARTNER_ IS '';
COMMENT ON COLUMN TBFAMILY.DDDPARTNER IS '';
COMMENT ON COLUMN TBFAMILY.FONEPARTNER IS '';

COMMENT ON COLUMN TBFAMILY.OBSERVATION IS '';
...
COMMENT ON TABLE TBADDRESS IS '';
COMMENT ON COLUMN TBADDRESS.ID_ IS '';
COMMENT ON COLUMN TBADDRESS.IDCUSTOMER IS '';
COMMENT ON COLUMN TBADDRESS.ADDRESS IS '';
COMMENT ON COLUMN TBADDRESS.NUMBER IS '';
COMMENT ON COLUMN TBADDRESS.DISTRICT IS '';
COMMENT ON COLUMN TBADDRESS.COMPLEMENT IS '';
COMMENT ON COLUMN TBADDRESS.CEP IS '';
COMMENT ON COLUMN TBADDRESS.IDCITY_ IS '';
COMMENT ON COLUMN TBADDRESS.DDD IS '';
COMMENT ON COLUMN TBADDRESS.FONE IS '';
COMMENT ON COLUMN TBADDRESS.MAIL IS '';
COMMENT ON COLUMN TBADDRESS.OBSERVATION IS '';
