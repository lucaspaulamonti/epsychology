...
type
  TFormJobOccupation = class(TFormCadastre)
  protected
...
var
  FormJobOccupation: TFormJobOccupation;
...
// Overrides the GetSQL function on UnitCadastre.
function TFormJobOccupation.GetSQL: string;
begin
  Result := 'SELECT * FROM JOBOCCUPATION';
end;
