...
type
  TFormEthnicGroup = class(TFormCadastre)
  protected
...
var
  FormEthnicGroup: TFormEthnicGroup;
...
// Overrides the GetSQL function on UnitCadastre.
function TFormEthnicGroup.GetSQL: string;
begin
  Result := 'SELECT * FROM ETHNICGROUP';
end;
