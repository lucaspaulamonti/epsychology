...
type
  TFormMaritalStatus = class(TFormCadastre)
  protected
...
var
  FormMaritalStatus: TFormMaritalStatus;
...
// Overrides the GetSQL function on UnitCadastre.
function TFormMaritalStatus.GetSQL: string;
begin
  Result := 'SELECT * FROM MARITALSTATUS';
end;
