...
DRUGADDICTION, PK_DRUGADDICTION__ID, UQ_DRUGADDICTION__ID_CUSTOMER, NN_DRUGADDICTION__ID_CUSTOMER, FK_DRUGADDICTION_CUSTOMER__ID, FK_DRUGADDICTION_USEFREQUENCY__ALCOHOL, FK_DRUGADDICTION_USEFREQUENCY__TOBACCO, FK_DRUGADDICTION_USEFREQUENCY__MARIHUANA, FK_DRUGADDICTION_USEFREQUENCY__ECSTASY, FK_DRUGADDICTION_USEFREQUENCY__LSD, FK_DRUGADDICTION_USEFREQUENCY__COCAINE, FK_DRUGADDICTION_USEFREQUENCY__CRACK, FK_DRUGADDICTION_USEFREQUENCY__HEROIN, FK_DRUGADDICTION_USEFREQUENCY__OPIUM, FK_DRUGADDICTION_USEFREQUENCY__AMPHETAMINE, SQ_DRUGADDICTION__ID, BI_DRUGADDICTION__ID(), BI_DRUGADDICTION__ID.
